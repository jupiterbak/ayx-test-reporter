...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AlteryxConnectBase = exports.isTokenRotation = void 0;
const cross_fetch_1 = __nccwpck_require__(9805);
const debug = __nccwpck_require__(7358);
const utils_1 = __nccwpck_require__(2579);
const version_1 = __nccwpck_require__(285);
...
class AlteryxConnectBase {
    constructor() {
        this._headers = {
            Accept: "*/*",
            "X-Powered-By": "meowz",
            "User-Agent": `${version_1.AYX_NAME} (${version_1.AYX_VERSION})`,
        };
        /**
         ...
         */
        this._multipartHeaders = Object.assign(Object.assign({}, this._headers), { "Content-Type": "multipart/mixed; boundary=alteryxmessage" });
        this._multipartFormData = Object.assign(Object.assign({}, this._headers), { "Content-Type": "multipart/form-data; boundary=--alteryx" });
        /**
...
exports.AlteryxConnectBase = AlteryxConnectBase;
//# sourceMappingURL=alteryx-base.js.map
...
const debug = __nccwpck_require__(7358);
const alteryx_base_1 = __nccwpck_require__(5036);
const utils_1 = __nccwpck_require__(2579);
const log = debug("alteryx-authbase");
class AuthBase extends alteryx_base_1.AlteryxConnectBase {
    /**
     ...
     */
    constructor(_gateway, _basicAuth) {
        super();
...
const debug = __nccwpck_require__(7358);
const cross_fetch_1 = __nccwpck_require__(9805);
const auth_base_1 = __nccwpck_require__(2901);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.adminWorkflowDataTemplate = void 0;
var FormData = __nccwpck_require__(4300);
const adminWorkflowDataTemplate = (params) => {
...
exports.adminWorkflowDataTemplate = adminWorkflowDataTemplate;
//# sourceMappingURL=admin-data-template.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AdminManagementClient = void 0;
const adminV2_1 = __nccwpck_require__(8306);
/**
 * The Admin Management API provides a means form managing the server.
 * @export
 * @extends {SdkClient}
 */
class AdminManagementClient extends adminV2_1.AdminManagementClientV2 {
    constructor() {
        super(...arguments);
        this._baseUrl = "admin/v1";
    }
}
exports.AdminManagementClient = AdminManagementClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AdminManagementClientV1 = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
const modelsV1_1 = __nccwpck_require__(9741);
const admin_data_template_1 = __nccwpck_require__(9165);
/**
 * The Admin Management API provides a means to automate administrative tasks (API V1).
 * @export
 * @extends {SdkClient}
 */
class AdminManagementClientV1 extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrlV1 = "/admin/v1";
    }
    /**
      ...
      */
    AdminGetAllAppsV1(startDate, endDate, page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (startDate) {
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetAppInfoV1(appId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling AdminGetAppInfoV1.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetAppOutputInfoV1(appIds, includeMessages) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (appIds) {
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetAppsV1(search, sortField, direction, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (search) {
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetDataConnectionsV1(offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (offset) {
                params['offset'] = offset;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetInsightsV1(search, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (search) {
                params['search'] = search;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetMigratableAppsV1(subscriptionIds) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'subscriptionIds' is not null or undefined
            if (subscriptionIds === null || subscriptionIds === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('subscriptionIds', 'Required parameter subscriptionIds was null or undefined when calling AdminGetMigratableAppsV1.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetPagedAuditLogV1(entity, page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'entity' is not null or undefined
            if (entity === null || entity === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('entity', 'Required parameter entity was null or undefined when calling AdminGetPagedAuditLogV1.');
            }
            // verify required parameter 'page' is not null or undefined
            if (page === null || page === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('page', 'Required parameter page was null or undefined when calling AdminGetPagedAuditLogV1.');
            }
            // verify required parameter 'pageSize' is not null or undefined
            if (pageSize === null || pageSize === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('pageSize', 'Required parameter pageSize was null or undefined when calling AdminGetPagedAuditLogV1.');
            }
            const params = {};
            if (entity) {
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetPagedCollectionsV1(page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (page) {
                params['page'] = page;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetPagedSchedulesV1(page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (page) {
                params['page'] = page;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetPagedSubscriptionsV1(page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (page) {
                params['page'] = page;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetPagedUsersV1(page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (page) {
                params['page'] = page;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminGetSystemDataConnectionsV1(offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (offset) {
                params['offset'] = offset;
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminPublishYxzpV1(file, name, owner, validate, isPublic, canDownload, workerTag, comments, sourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'file' is not null or undefined
            if (file === null || file === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('file', 'Required parameter file was null or undefined when calling AdminPublishYxzpV1.');
            }
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('name', 'Required parameter name was null or undefined when calling AdminPublishYxzpV1.');
            }
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('owner', 'Required parameter owner was null or undefined when calling AdminPublishYxzpV1.');
            }
            // verify required parameter 'validate' is not null or undefined
            if (validate === null || validate === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('validate', 'Required parameter validate was null or undefined when calling AdminPublishYxzpV1.');
            }
            // verify required parameter 'isPublic' is not null or undefined
            if (isPublic === null || isPublic === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('isPublic', 'Required parameter isPublic was null or undefined when calling AdminPublishYxzpV1.');
            }
            // verify required parameter 'canDownload' is not null or undefined
            if (canDownload === null || canDownload === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('canDownload', 'Required parameter canDownload was null or undefined when calling AdminPublishYxzpV1.');
            }
            const params = {};
            if (file) {
                params['file'] = file;
            ...
            return (yield this.HttpAction({
                ...
                body: (0, admin_data_template_1.adminWorkflowDataTemplate)(params),
     ...
     * @memberOf AdminManagementClientV1
     */
    AdminUpdateAppMigrationV1(appId, isReadyForMigration) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling AdminUpdateAppMigrationV1.');
            }
            ...
            if (isReadyForMigration === null || isReadyForMigration === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('isReadyForMigration', 'Required parameter isReadyForMigration was null or undefined when calling AdminUpdateAppMigrationV1.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
...
exports.AdminManagementClientV1 = AdminManagementClientV1;
//# sourceMappingURL=adminV1.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AdminManagementClientV2 = void 0;
const utils_1 = __nccwpck_require__(2579);
const modelsV2_1 = __nccwpck_require__(8052);
const adminV1_1 = __nccwpck_require__(9602);
/**
 * The Admin Management API provides a means to automate administrative tasks (API V1).
 * @export
 * @extends {SdkClient}
 */
class AdminManagementClientV2 extends adminV1_1.AdminManagementClientV1 {
    constructor() {
        super(...arguments);
        this._baseUrlV2 = "/admin/v2";
    }
    /**
      *
      * @summary Return all workflows, optionally filtered by date
      ...
      */
    AdminGetAllAppsV2(name, startDate, endDate, subscriptionId, page, pageSize, useEvents) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (name) {
                params['name'] = name;
     ...
     * @memberOf AdminManagementClientV2
     */
    AdminGetInsightsV2(search, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (search) {
                params['search'] = search;
     ...
     * @memberOf AdminManagementClientV2
     */
    AdminGetPagedSubscriptionsV2(page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (page) {
                params['page'] = page;
     ...
     * @memberOf AdminManagementClientV2
     */
    AdminGetPagedUsersV2(subscriptionId, page, pageSize) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (subscriptionId) {
                params['subscriptionId'] = subscriptionId;
     ...
     * @memberOf AdminManagementClientV2
     */
    AdminGetScheduleForecastV2(beforeDate, afterDate) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'beforeDate' is not null or undefined
            if (beforeDate === null || beforeDate === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('beforeDate', 'Required parameter beforeDate was null or undefined when calling AdminGetScheduleForecastV2.');
            }
            // verify required parameter 'afterDate' is not null or undefined
            if (afterDate === null || afterDate === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('afterDate', 'Required parameter afterDate was null or undefined when calling AdminGetScheduleForecastV2.');
            }
            const params = {};
            if (beforeDate) {
...
exports.AdminManagementClientV2 = AdminManagementClientV2;
//# sourceMappingURL=adminV2.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CollectionManagementClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const models_1 = __nccwpck_require__(2654);
const sdk_client_1 = __nccwpck_require__(4709);
/**
 ...
 */
class CollectionManagementClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/collections";
    }
    /**
     *
     ...
     */
    AddInsightToCollection(collectionId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling AddInsightToCollection.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling AddInsightToCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    AddScheduleToCollection(collectionId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling AddScheduleToCollection.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling AddScheduleToCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    AddUserGroupToCollection(collectionId, addUserGroupsContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling AddUserGroupToCollection.');
            }
            ...
            if (addUserGroupsContract === null || addUserGroupsContract === undefined) {
                throw new models_1.SDKModels.RequiredError('addUserGroupsContract', 'Required parameter addUserGroupsContract was null or undefined when calling AddUserGroupToCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    AddUserToCollection(collectionId, addUsersContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling AddUserToCollection.');
            }
            // verify required parameter 'addUsersContract' is not null or undefined
            if (addUsersContract === null || addUsersContract === undefined) {
                throw new models_1.SDKModels.RequiredError('addUsersContract', 'Required parameter addUsersContract was null or undefined when calling AddUserToCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    AddWorkflowToCollection(collectionId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling AddWorkflowToCollection.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling AddWorkflowToCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    CreateCollection(contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling CreateCollection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    DeleteCollection(collectionId, forceDelete) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling DeleteCollection.');
            }
            const params = {};
            if (forceDelete) {
    ...
    GetCollection(collectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling GetCollection.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    RemoveInsightFromCollection(collectionId, insightId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling RemoveInsightFromCollection.');
            }
            // verify required parameter 'insightId' is not null or undefined
            if (insightId === null || insightId === undefined) {
                throw new models_1.SDKModels.RequiredError('insightId', 'Required parameter insightId was null or undefined when calling RemoveInsightFromCollection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    RemoveScheduleFromCollection(collectionId, scheduleId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling RemoveScheduleFromCollection.');
            }
            // verify required parameter 'scheduleId' is not null or undefined
            if (scheduleId === null || scheduleId === undefined) {
                throw new models_1.SDKModels.RequiredError('scheduleId', 'Required parameter scheduleId was null or undefined when calling RemoveScheduleFromCollection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    RemoveUserFromCollection(collectionId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling RemoveUserFromCollection.');
            }
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new models_1.SDKModels.RequiredError('userId', 'Required parameter userId was null or undefined when calling RemoveUserFromCollection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    RemoveUserGroupFromCollection(collectionId, userGroupId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling RemoveUserGroupFromCollection.');
            }
            // verify required parameter 'userGroupId' is not null or undefined
            if (userGroupId === null || userGroupId === undefined) {
                throw new models_1.SDKModels.RequiredError('userGroupId', 'Required parameter userGroupId was null or undefined when calling RemoveUserGroupFromCollection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    RemoveWorkflowFromCollection(collectionId, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling RemoveWorkflowFromCollection.');
            }
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new models_1.SDKModels.RequiredError('appId', 'Required parameter appId was null or undefined when calling RemoveWorkflowFromCollection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    UpdateCollection(collectionId, updateCollectionContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling UpdateCollection.');
            }
            ...
            if (updateCollectionContract === null || updateCollectionContract === undefined) {
                throw new models_1.SDKModels.RequiredError('updateCollectionContract', 'Required parameter updateCollectionContract was null or undefined when calling UpdateCollection.');
            }
            return (yield this.HttpAction({
                verb: "PUT",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    UpdateCollectionUserGroupPermissions(collectionId, userGroupId, updatePermissionsContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling UpdateCollectionUserGroupPermissions.');
            }
            // verify required parameter 'userGroupId' is not null or undefined
            if (userGroupId === null || userGroupId === undefined) {
                throw new models_1.SDKModels.RequiredError('userGroupId', 'Required parameter userGroupId was null or undefined when calling UpdateCollectionUserGroupPermissions.');
            }
            ...
            if (updatePermissionsContract === null || updatePermissionsContract === undefined) {
                throw new models_1.SDKModels.RequiredError('updatePermissionsContract', 'Required parameter updatePermissionsContract was null or undefined when calling UpdateCollectionUserGroupPermissions.');
            }
            return (yield this.HttpAction({
                verb: "PUT",
                gateway: this.GetGateway(),
     ...
     * @memberOf CollectionManagementClient
     */
    UpdateCollectionUserPermissions(collectionId, userId, updatePermissionsContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'collectionId' is not null or undefined
            if (collectionId === null || collectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('collectionId', 'Required parameter collectionId was null or undefined when calling UpdateCollectionUserPermissions.');
            }
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new models_1.SDKModels.RequiredError('userId', 'Required parameter userId was null or undefined when calling UpdateCollectionUserPermissions.');
            }
            // verify required parameter 'updatePermissionsContract' is not null or undefined
            if (updatePermissionsContract === null || updatePermissionsContract === undefined) {
                throw new models_1.SDKModels.RequiredError('updatePermissionsContract', 'Required parameter updatePermissionsContract was null or undefined when calling UpdateCollectionUserPermissions.');
            }
            return (yield this.HttpAction({
                verb: "PUT",
                gateway: this.GetGateway(),
...
exports.CollectionManagementClient = CollectionManagementClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AlteryxSdk = void 0;
const user_1 = __nccwpck_require__(3826);
const workflow_1 = __nccwpck_require__(8859);
const group_1 = __nccwpck_require__(2861);
const schedule_1 = __nccwpck_require__(4631);
const credentials_1 = __nccwpck_require__(5580);
const dcmeconnections_1 = __nccwpck_require__(7043);
const serverconnection_1 = __nccwpck_require__(9116);
const job_1 = __nccwpck_require__(3615);
const admin_1 = __nccwpck_require__(2676);
const collection_1 = __nccwpck_require__(5144);
const sdk_client_1 = __nccwpck_require__(4709);
/**
 *
 ...
 * @class AlteryxSdk
 */
class AlteryxSdk extends sdk_client_1.SdkClient {
    /**
    ...
    GetUserManagementClient() {
        this._userManagementClient =
            this._userManagementClient || new user_1.UserManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetWorkflowManagementClient() {
        this._workflowManagementClient =
            this._workflowManagementClient || new workflow_1.WorkflowManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetUserGroupManagementClient() {
        this._userGroupManagementClient =
            this._userGroupManagementClient || new group_1.UserGroupManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetCredentialsManagementClient() {
        this._credentialsManagementClient =
            this._credentialsManagementClient || new credentials_1.CredentialsManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetScheduleManagementClient() {
        this._scheduleGroupManagementClient =
            this._scheduleGroupManagementClient || new schedule_1.ScheduleManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetDCMEConnectionClient() {
        this._dcmeClient =
            this._dcmeClient || new dcmeconnections_1.DCMEConnectionClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetServerConnectionClient() {
        this._sercerConnectionClient =
            this._sercerConnectionClient || new serverconnection_1.ServerConnectionClient(this._authenticator);
    ...
    GetJobManagementClient() {
        this._jobConnectionClient =
            this._jobConnectionClient || new job_1.JobManagementClient(this._authenticator);
    ...
    GetAdminManagementClient() {
        this._adminManagementClient =
            this._adminManagementClient || new admin_1.AdminManagementClient(this._authenticator);
     ...
     * @memberOf AlteryxSdk
     */
    GetCollectionManagementClient() {
        this._collectionManagementClient =
            this._collectionManagementClient || new collection_1.CollectionManagementClient(this._authenticator);
        return this._collectionManagementClient;
    }
}
exports.AlteryxSdk = AlteryxSdk;
//# sourceMappingURL=alteryx-sdk.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isTokenCredentials = exports.isClientCredentials = exports.isUserCredentials = exports.isSecretCredentials = void 0;
function isSecretCredentials(obj) {
    return obj && obj.gateway && obj.clientId && obj.clientSecret;
}
exports.isSecretCredentials = isSecretCredentials;
function isUserCredentials(obj) {
    return obj && obj.gateway && obj.user && obj.password;
}
exports.isUserCredentials = isUserCredentials;
function isClientCredentials(obj) {
    return obj && obj.gateway && obj.basicAuth;
}
exports.isClientCredentials = isClientCredentials;
function isTokenCredentials(obj) {
    return obj && obj.gateway && obj.token;
}
exports.isTokenCredentials = isTokenCredentials;
...
const credential_auth_1 = __nccwpck_require__(5877);
const tokenmanager_auth_1 = __nccwpck_require__(9270);
const alteryx_base_1 = __nccwpck_require__(5036);
const credentials_1 = __nccwpck_require__(6090);
const credentials_2 = __nccwpck_require__(6090);
const secret_credential_auth_1 = __nccwpck_require__(1670);
const user_auth_1 = __nccwpck_require__(3130);
class SdkClient {
    /**
    ...
    constructor(credentialsOrAuthorizer) {
        ...
        else if ((0, alteryx_base_1.isTokenRotation)(credentialsOrAuthorizer)) {
            this._authenticator = credentialsOrAuthorizer;
        }
        else if ((0, credentials_1.isTokenCredentials)(credentialsOrAuthorizer)) {
            const userCredentials = credentialsOrAuthorizer;
            this._authenticator = new tokenmanager_auth_1.TokenManagerAuth(userCredentials.gateway, userCredentials.token);
        }
        else if ((0, credentials_2.isUserCredentials)(credentialsOrAuthorizer)) {
            const userCredentials = credentialsOrAuthorizer;
            this._authenticator = new user_auth_1.UserAuth(userCredentials.gateway, userCredentials.user, userCredentials.password);
        }
        else if ((0, credentials_1.isSecretCredentials)(credentialsOrAuthorizer)) {
            const secretCredentials = credentialsOrAuthorizer;
            this._authenticator = new secret_credential_auth_1.SecretCredentialAuth(secretCredentials.gateway, secretCredentials.clientId, secretCredentials.clientSecret);
        }
        else if ((0, credentials_2.isClientCredentials)(credentialsOrAuthorizer)) {
            const credentialsAuth = credentialsOrAuthorizer;
            this._authenticator = new credential_auth_1.CredentialAuth(credentialsAuth.gateway, credentialsAuth.basicAuth);
        }
        else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CredentialsManagementClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
const models_1 = __nccwpck_require__(2654);
/**
 ...
 * @extends {SdkClient}
 */
class CredentialsManagementClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/credentials";
    }
    /**
     *
     ...
     */
    DeleteCredential(credentialId, force) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling DeleteCredential.');
            }
            const qs = (0, utils_1.toQueryString)({ force: force || false });
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
    ...
    GetCredential(credentialId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling GetCredential.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf CredentialsManagementClient
     */
    ShareCredentialWithUser(credentialId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling ShareCredentialWithUser.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling ShareCredentialWithUser.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CredentialsManagementClient
     */
    ShareCredentialWithUserGroup(credentialId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling ShareCredentialWithUserGroup.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling ShareCredentialWithUserGroup.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf CredentialsManagementClient
     */
    RemoveUserFromCredential(credentialId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling RemoveUserFromCredential.');
            }
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new models_1.SDKModels.RequiredError('userId', 'Required parameter userId was null or undefined when calling RemoveUserFromCredential.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf CredentialsManagementClient
     */
    RemoveUserGroupFromCredential(credentialId, userGroupId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'credentialId' is not null or undefined
            if (credentialId === null || credentialId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling RemoveUserGroupFromCredential.');
            }
            // verify required parameter 'userGroupId' is not null or undefined
            if (userGroupId === null || userGroupId === undefined) {
                throw new models_1.SDKModels.RequiredError('userGroupId', 'Required parameter userGroupId was null or undefined when calling RemoveUserGroupFromCredential.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
...
exports.CredentialsManagementClient = CredentialsManagementClient;
//# sourceMappingURL=credentials.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DCMEConnectionClient = void 0;
const sdk_client_1 = __nccwpck_require__(4709);
const models_1 = __nccwpck_require__(2654);
/**
 ...
 * @extends {SdkClient}
 */
class DCMEConnectionClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/DCMEConnections";
    }
    /**
     *
     ...
     */
    GetDCMEConnection(connectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'connectionId' is not null or undefined
            if (connectionId === null || connectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('connectionId', 'Required parameter connectionId was null or undefined when calling GetDCMEConnection.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
...
exports.DCMEConnectionClient = DCMEConnectionClient;
//# sourceMappingURL=dcmeconnections.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UserGroupManagementClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
/**
 ...
 * @extends {SdkClient}
 */
class UserGroupManagementClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/usergroups";
    }
    /**
     ...
     * @memberOf UserGroupManagementClient
     */
    DeleteUserGroup(id, forceDelete) {
        return __awaiter(this, void 0, void 0, function* () {
            const qs = (0, utils_1.toQueryString)({ forceDelete: forceDelete || false });
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
     ...
     * @memberOf UserGroupManagementClient
     */
    RemoveUserFromGroup(userGroupId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
...
exports.UserGroupManagementClient = UserGroupManagementClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(6090), exports);
__exportStar(__nccwpck_require__(5872), exports);
__exportStar(__nccwpck_require__(4709), exports);
__exportStar(__nccwpck_require__(2654), exports);
...
__exportStar(__nccwpck_require__(8859), exports);
__exportStar(__nccwpck_require__(2861), exports);
__exportStar(__nccwpck_require__(4631), exports);
__exportStar(__nccwpck_require__(5580), exports);
__exportStar(__nccwpck_require__(7043), exports);
__exportStar(__nccwpck_require__(9116), exports);
__exportStar(__nccwpck_require__(3615), exports);
__exportStar(__nccwpck_require__(2676), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.JobManagementClient = void 0;
const jobV1_1 = __nccwpck_require__(5371);
/**
 * The Workflow Management API provides a means form managing workflows.
 * @export
 * @extends {SdkClient}
 */
class JobManagementClient extends jobV1_1.JobManagementClientV1 {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v1/jobs";
    }
}
exports.JobManagementClient = JobManagementClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.JobManagementClientV1 = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
const modelsV1_1 = __nccwpck_require__(9741);
/**
 ...
 * @extends {SdkClient}
 */
class JobManagementClientV1 extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrlV1 = "/v1/jobs";
    }
    /**
     ...
     */
    GetJobDetailsV1(id, includeMessages) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('id', 'Required parameter id was null or undefined when calling GetJobV1.');
            }
            const params = {};
            if (includeMessages) {
                params['includeMessages'] = includeMessages;
     ...
     * @memberOf JobManagementClientV1
     */
    GetJobOutputFileV1(id, outputId, format) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('id', 'Required parameter id was null or undefined when calling GetJobOutputFileV1.');
            }
            // verify required parameter 'outputId' is not null or undefined
            if (outputId === null || outputId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('outputId', 'Required parameter outputId was null or undefined when calling GetJobOutputFileV1.');
            }
            // verify required parameter 'format' is not null or undefined
            if (format === null || format === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('format', 'Required parameter format was null or undefined when calling GetJobOutputFileV1.');
            }
...
exports.JobManagementClientV1 = JobManagementClientV1;
...
(function (SDKModels) {
    ...
    SDKModels.RequiredError = RequiredError;
    /**
     * @export
     * @namespace ADObject
     */
    ...
    (function (ADObject) {
        ...
        (function (CategoryEnum) {
            CategoryEnum[CategoryEnum["Person"] = 'Person'] = "Person";
            CategoryEnum[CategoryEnum["Group"] = 'Group'] = "Group";
        })(CategoryEnum = ADObject.CategoryEnum || (ADObject.CategoryEnum = {}));
    })(ADObject = SDKModels.ADObject || (SDKModels.ADObject = {}));
    /**
     * @export
     * @namespace ActiveDirectoryObject
     */
    let ActiveDirectoryObject;
    (function (ActiveDirectoryObject) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (CategoryEnum) {
            CategoryEnum[CategoryEnum["Person"] = 'Person'] = "Person";
            CategoryEnum[CategoryEnum["Group"] = 'Group'] = "Group";
        })(CategoryEnum = ActiveDirectoryObject.CategoryEnum || (ActiveDirectoryObject.CategoryEnum = {}));
    })(ActiveDirectoryObject = SDKModels.ActiveDirectoryObject || (SDKModels.ActiveDirectoryObject = {}));
    /**
     * @export
     * @namespace CreateScheduleContract
     */
    let CreateScheduleContract;
    (function (CreateScheduleContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (PriorityEnum) {
            PriorityEnum[PriorityEnum["Default"] = 'Default'] = "Default";
        ...
        })(PriorityEnum = CreateScheduleContract.PriorityEnum || (CreateScheduleContract.PriorityEnum = {}));
    })(CreateScheduleContract = SDKModels.CreateScheduleContract || (SDKModels.CreateScheduleContract = {}));
    /**
     * @export
     * @namespace CreateUserGroupContract
     */
    let CreateUserGroupContract;
    (function (CreateUserGroupContract) {
        /**
         * @export
         * @enum {string}
         */
        let RoleEnum;
        (function (RoleEnum) {
            RoleEnum[RoleEnum["NoAccess"] = 'NoAccess'] = "NoAccess";
            RoleEnum[RoleEnum["Viewer"] = 'Viewer'] = "Viewer";
            RoleEnum[RoleEnum["Member"] = 'Member'] = "Member";
            RoleEnum[RoleEnum["Artisan"] = 'Artisan'] = "Artisan";
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = CreateUserGroupContract.RoleEnum || (CreateUserGroupContract.RoleEnum = {}));
    })(CreateUserGroupContract = SDKModels.CreateUserGroupContract || (SDKModels.CreateUserGroupContract = {}));
    /**
     * @export
    ...
    (function (IterationContract) {
         ...
         * @enum {string}
         */
        let IterationTypeEnum;
        (function (IterationTypeEnum) {
            IterationTypeEnum[IterationTypeEnum["Once"] = 'Once'] = "Once";
            IterationTypeEnum[IterationTypeEnum["Hourly"] = 'Hourly'] = "Hourly";
            IterationTypeEnum[IterationTypeEnum["Weekly"] = 'Weekly'] = "Weekly";
            IterationTypeEnum[IterationTypeEnum["Monthly"] = 'Monthly'] = "Monthly";
            IterationTypeEnum[IterationTypeEnum["Custom"] = 'Custom'] = "Custom";
            IterationTypeEnum[IterationTypeEnum["Daily"] = 'Daily'] = "Daily";
        })(IterationTypeEnum = IterationContract.IterationTypeEnum || (IterationContract.IterationTypeEnum = {}));
    })(IterationContract = SDKModels.IterationContract || (SDKModels.IterationContract = {}));
    /**
     * @export
     * @namespace IterationMonthlyContract
     */
    let IterationMonthlyContract;
    (function (IterationMonthlyContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        })(DayOfWeekEnum = IterationMonthlyContract.DayOfWeekEnum || (IterationMonthlyContract.DayOfWeekEnum = {}));
    })(IterationMonthlyContract = SDKModels.IterationMonthlyContract || (SDKModels.IterationMonthlyContract = {}));
    /**
     * @export
     * @namespace IterationWeeklyContract
     */
    let IterationWeeklyContract;
    (function (IterationWeeklyContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        })(DaysOfWeekEnum = IterationWeeklyContract.DaysOfWeekEnum || (IterationWeeklyContract.DaysOfWeekEnum = {}));
    })(IterationWeeklyContract = SDKModels.IterationWeeklyContract || (SDKModels.IterationWeeklyContract = {}));
    /**
     * @export
     * @namespace ReducedUserGroupView
     */
    let ReducedUserGroupView;
    (function (ReducedUserGroupView) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = ReducedUserGroupView.RoleEnum || (ReducedUserGroupView.RoleEnum = {}));
    })(ReducedUserGroupView = SDKModels.ReducedUserGroupView || (SDKModels.ReducedUserGroupView = {}));
    /**
     * @export
     * @namespace ReducedUserView
     */
    let ReducedUserView;
    (function (ReducedUserView) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = ReducedUserView.RoleEnum || (ReducedUserView.RoleEnum = {}));
    })(ReducedUserView = SDKModels.ReducedUserView || (SDKModels.ReducedUserView = {}));
    /**
     * @export
     * @namespace ReducedWorkflowView
     */
    let ReducedWorkflowView;
    (function (ReducedWorkflowView) {
        /**
         * @export
         * @enum {string}
         */
        let ExecutionModeEnum;
        (function (ExecutionModeEnum) {
            ExecutionModeEnum[ExecutionModeEnum["Safe"] = 'Safe'] = "Safe";
            ExecutionModeEnum[ExecutionModeEnum["SemiSafe"] = 'SemiSafe'] = "SemiSafe";
            ExecutionModeEnum[ExecutionModeEnum["Standard"] = 'Standard'] = "Standard";
        })(ExecutionModeEnum = ReducedWorkflowView.ExecutionModeEnum || (ReducedWorkflowView.ExecutionModeEnum = {}));
    })(ReducedWorkflowView = SDKModels.ReducedWorkflowView || (SDKModels.ReducedWorkflowView = {}));
    /**
     * @export
    ...
    (function (ScheduleView) {
        ...
        (function (PriorityEnum) {
            ...
            PriorityEnum[PriorityEnum["High"] = 'High'] = "High";
            PriorityEnum[PriorityEnum["Critical"] = 'Critical'] = "Critical";
        })(PriorityEnum = ScheduleView.PriorityEnum || (ScheduleView.PriorityEnum = {}));
    })(ScheduleView = SDKModels.ScheduleView || (SDKModels.ScheduleView = {}));
    /**
     * @export
     * @namespace SearchUserContract
     */
    let SearchUserContract;
    (function (SearchUserContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = SearchUserContract.RoleEnum || (SearchUserContract.RoleEnum = {}));
    })(SearchUserContract = SDKModels.SearchUserContract || (SDKModels.SearchUserContract = {}));
    /**
     * @export
     * @namespace UpdateScheduleContract
     */
    let UpdateScheduleContract;
    (function (UpdateScheduleContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (PriorityEnum) {
            ...
            PriorityEnum[PriorityEnum["High"] = 'High'] = "High";
            PriorityEnum[PriorityEnum["Critical"] = 'Critical'] = "Critical";
        })(PriorityEnum = UpdateScheduleContract.PriorityEnum || (UpdateScheduleContract.PriorityEnum = {}));
    })(UpdateScheduleContract = SDKModels.UpdateScheduleContract || (SDKModels.UpdateScheduleContract = {}));
    /**
     * @export
     * @namespace UpdateUserContract
     */
    let UpdateUserContract;
    (function (UpdateUserContract) {
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = UpdateUserContract.RoleEnum || (UpdateUserContract.RoleEnum = {}));
    })(UpdateUserContract = SDKModels.UpdateUserContract || (SDKModels.UpdateUserContract = {}));
    /**
     * @export
     * @namespace UpdateUserGroupContract
     */
    let UpdateUserGroupContract;
    (function (UpdateUserGroupContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = UpdateUserGroupContract.RoleEnum || (UpdateUserGroupContract.RoleEnum = {}));
    })(UpdateUserGroupContract = SDKModels.UpdateUserGroupContract || (SDKModels.UpdateUserGroupContract = {}));
    /**
     * @export
     * @namespace UpdateWorkflowContract
     */
    let UpdateWorkflowContract;
    (function (UpdateWorkflowContract) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (ExecutionModeEnum) {
            ...
            ExecutionModeEnum[ExecutionModeEnum["SemiSafe"] = 'SemiSafe'] = "SemiSafe";
            ExecutionModeEnum[ExecutionModeEnum["Standard"] = 'Standard'] = "Standard";
        })(ExecutionModeEnum = UpdateWorkflowContract.ExecutionModeEnum || (UpdateWorkflowContract.ExecutionModeEnum = {}));
    })(UpdateWorkflowContract = SDKModels.UpdateWorkflowContract || (SDKModels.UpdateWorkflowContract = {}));
    /**
     * @export
    ...
    (function (UserGroupView) {
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = UserGroupView.RoleEnum || (UserGroupView.RoleEnum = {}));
    })(UserGroupView = SDKModels.UserGroupView || (SDKModels.UserGroupView = {}));
    /**
     * @export
     * @namespace UserView
     */
    ...
    (function (UserView) {
        ...
        (function (RoleEnum) {
            ...
            RoleEnum[RoleEnum["Curator"] = 'Curator'] = "Curator";
            RoleEnum[RoleEnum["Evaluated"] = 'Evaluated'] = "Evaluated";
        })(RoleEnum = UserView.RoleEnum || (UserView.RoleEnum = {}));
    })(UserView = SDKModels.UserView || (SDKModels.UserView = {}));
    /**
     * @export
     * @namespace WorkflowVersionView
     */
    let WorkflowVersionView;
    (function (WorkflowVersionView) {
        /**
         * @export
         * @enum {string}
         */
        let UploadSourceEnum;
        (function (UploadSourceEnum) {
            UploadSourceEnum[UploadSourceEnum["Designer"] = 'Designer'] = "Designer";
            UploadSourceEnum[UploadSourceEnum["Direct"] = 'Direct'] = "Direct";
        })(UploadSourceEnum = WorkflowVersionView.UploadSourceEnum || (WorkflowVersionView.UploadSourceEnum = {}));
        /**
         * @export
         * @enum {string}
         */
        let PackageWorkflowTypeEnum;
        (function (PackageWorkflowTypeEnum) {
            PackageWorkflowTypeEnum[PackageWorkflowTypeEnum["App"] = 'App'] = "App";
            PackageWorkflowTypeEnum[PackageWorkflowTypeEnum["Module"] = 'Module'] = "Module";
            PackageWorkflowTypeEnum[PackageWorkflowTypeEnum["Macro"] = 'Macro'] = "Macro";
        })(PackageWorkflowTypeEnum = WorkflowVersionView.PackageWorkflowTypeEnum || (WorkflowVersionView.PackageWorkflowTypeEnum = {}));
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (ExecutionModeEnum) {
            ...
            ExecutionModeEnum[ExecutionModeEnum["SemiSafe"] = 'SemiSafe'] = "SemiSafe";
            ExecutionModeEnum[ExecutionModeEnum["Standard"] = 'Standard'] = "Standard";
        })(ExecutionModeEnum = WorkflowVersionView.ExecutionModeEnum || (WorkflowVersionView.ExecutionModeEnum = {}));
        /**
         * @export
         * @enum {string}
         */
        let WorkflowCredentialTypeEnum;
        (function (WorkflowCredentialTypeEnum) {
            WorkflowCredentialTypeEnum[WorkflowCredentialTypeEnum["Default"] = 'Default'] = "Default";
            WorkflowCredentialTypeEnum[WorkflowCredentialTypeEnum["Required"] = 'Required'] = "Required";
            WorkflowCredentialTypeEnum[WorkflowCredentialTypeEnum["Specific"] = 'Specific'] = "Specific";
        })(WorkflowCredentialTypeEnum = WorkflowVersionView.WorkflowCredentialTypeEnum || (WorkflowVersionView.WorkflowCredentialTypeEnum = {}));
    })(WorkflowVersionView = SDKModels.WorkflowVersionView || (SDKModels.WorkflowVersionView = {}));
    /**
     * @export
    ...
    (function (WorkflowView) {
        ...
        (function (ExecutionModeEnum) {
            ...
            ExecutionModeEnum[ExecutionModeEnum["SemiSafe"] = 'SemiSafe'] = "SemiSafe";
            ExecutionModeEnum[ExecutionModeEnum["Standard"] = 'Standard'] = "Standard";
        })(ExecutionModeEnum = WorkflowView.ExecutionModeEnum || (WorkflowView.ExecutionModeEnum = {}));
    })(WorkflowView = SDKModels.WorkflowView || (SDKModels.WorkflowView = {}));
})(SDKModels = exports.SDKModels || (exports.SDKModels = {}));
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SDKModelsV1 = void 0;
var SDKModelsV1;
(function (SDKModelsV1) {
    /**
     *
     * @export
     * @class RequiredError
    ...
    SDKModelsV1.RequiredError = RequiredError;
    /**
     * @export
     * @namespace ActiveDirectoryObject
     */
    ...
    })(ActiveDirectoryObject = SDKModelsV1.ActiveDirectoryObject || (SDKModelsV1.ActiveDirectoryObject = {}));
    /**
     * @export
    ...
    (function (JobApiView) {
        ...
        (function (PriorityEnum) {
            ...
            PriorityEnum[PriorityEnum["High"] = 'High'] = "High";
            PriorityEnum[PriorityEnum["Critical"] = 'Critical'] = "Critical";
        })(PriorityEnum = JobApiView.PriorityEnum || (JobApiView.PriorityEnum = {}));
    })(JobApiView = SDKModelsV1.JobApiView || (SDKModelsV1.JobApiView = {}));
    /**
     * @export
     * @namespace JobListApiView
     */
    let JobListApiView;
    (function (JobListApiView) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (PriorityEnum) {
            ...
            PriorityEnum[PriorityEnum["High"] = 'High'] = "High";
            PriorityEnum[PriorityEnum["Critical"] = 'Critical'] = "Critical";
        })(PriorityEnum = JobListApiView.PriorityEnum || (JobListApiView.PriorityEnum = {}));
    })(JobListApiView = SDKModelsV1.JobListApiView || (SDKModelsV1.JobListApiView = {}));
    /**
     * @export
     * @namespace ScheduleView
     */
    ...
    })(ScheduleView = SDKModelsV1.ScheduleView || (SDKModelsV1.ScheduleView = {}));
    /**
     * @export
     * @namespace WorkflowAdminApiView
     */
    let WorkflowAdminApiView;
    (function (WorkflowAdminApiView) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (PackageTypeEnum) {
            PackageTypeEnum[PackageTypeEnum["App"] = 'App'] = "App";
            PackageTypeEnum[PackageTypeEnum["Module"] = 'Module'] = "Module";
            PackageTypeEnum[PackageTypeEnum["Macro"] = 'Macro'] = "Macro";
        })(PackageTypeEnum = WorkflowAdminApiView.PackageTypeEnum || (WorkflowAdminApiView.PackageTypeEnum = {}));
    })(WorkflowAdminApiView = SDKModelsV1.WorkflowAdminApiView || (SDKModelsV1.WorkflowAdminApiView = {}));
    /**
     * @export
     * @namespace WorkflowApiView
     */
    let WorkflowApiView;
    (function (WorkflowApiView) {
        /**
         * @export
         * @enum {string}
         */
        ...
        (function (PackageTypeEnum) {
            ...
            PackageTypeEnum[PackageTypeEnum["Module"] = 'Module'] = "Module";
            PackageTypeEnum[PackageTypeEnum["Macro"] = 'Macro'] = "Macro";
        })(PackageTypeEnum = WorkflowApiView.PackageTypeEnum || (WorkflowApiView.PackageTypeEnum = {}));
    })(WorkflowApiView = SDKModelsV1.WorkflowApiView || (SDKModelsV1.WorkflowApiView = {}));
})(SDKModelsV1 = exports.SDKModelsV1 || (exports.SDKModelsV1 = {}));
//# sourceMappingURL=modelsV1.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SDKModelsV2 = void 0;
var SDKModelsV2;
(function (SDKModelsV2) {
    /**
     *
     * @export
     * @class RequiredError
    ...
    SDKModelsV2.RequiredError = RequiredError;
    /**
     * @export
     * @namespace JobApiView
     */
    ...
    })(JobApiView = SDKModelsV2.JobApiView || (SDKModelsV2.JobApiView = {}));
})(SDKModelsV2 = exports.SDKModelsV2 || (exports.SDKModelsV2 = {}));
//# sourceMappingURL=modelsV2.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ScheduleManagementClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
/**
 ...
 * @extends {SdkClient}
 */
class ScheduleManagementClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/schedules";
    }
    /**
     *
...
exports.ScheduleManagementClient = ScheduleManagementClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ServerConnectionClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
const models_1 = __nccwpck_require__(2654);
/**
 ...
 * @extends {SdkClient}
 */
class ServerConnectionClient extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/serverDataConnections";
    }
    /**
     ...
     */
    GetServerDataConnections(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const qs = (0, utils_1.toQueryString)(params);
            return (yield this.HttpAction({
                verb: "GET",
     ...
     * @memberOf ServerConnectionClient
     */
    DeleteServerDataConnection(dataConnectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('dataConnectionId', 'Required parameter dataConnectionId was null or undefined when calling DeleteServerDataConnection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    GetServerDataConnection(dataConnectionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('dataConnectionId', 'Required parameter dataConnectionId was null or undefined when calling ServerConnectionClient.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    UpdateServerDataConnectionName(dataConnectionId, updateServerConnectionContract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('dataConnectionId', 'Required parameter dataConnectionId was null or undefined when calling UpdateServerDataConnectionName.');
            }
            ...
            if (updateServerConnectionContract === null || updateServerConnectionContract === undefined) {
                throw new models_1.SDKModels.RequiredError('updateServerConnectionContract', 'Required parameter updateServerConnectionContract was null or undefined when calling UpdateServerDataConnectionName.');
            }
            return (yield this.HttpAction({
                verb: "PUT",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    AddUserToServerDataConnection(dataConnectionId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('dataConnectionId', 'Required parameter dataConnectionId was null or undefined when calling AddUserToServerDataConnection.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling AddUserToServerDataConnection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    AddUserGroupToServerDataConnection(dataConnectionId, contract) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('dataConnectionId', 'Required parameter dataConnectionId was null or undefined when calling AddUserGroupToServerDataConnection.');
            }
            // verify required parameter 'contract' is not null or undefined
            if (contract === null || contract === undefined) {
                throw new models_1.SDKModels.RequiredError('contract', 'Required parameter contract was null or undefined when calling AddUserGroupToServerDataConnection.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    RemoveUserFromServerDataConnection(dataConnectionId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling RemoveUserFromServerDataConnection.');
            }
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new models_1.SDKModels.RequiredError('userId', 'Required parameter userId was null or undefined when calling RemoveUserFromServerDataConnection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
     ...
     * @memberOf ServerConnectionClient
     */
    RemoveUserGroupFromServerDataConnection(dataConnectionId, userGroupId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'dataConnectionId' is not null or undefined
            if (dataConnectionId === null || dataConnectionId === undefined) {
                throw new models_1.SDKModels.RequiredError('credentialId', 'Required parameter credentialId was null or undefined when calling RemoveUserGroupFromServerDataConnection.');
            }
            // verify required parameter 'userId' is not null or undefined
            if (userGroupId === null || userGroupId === undefined) {
                throw new models_1.SDKModels.RequiredError('userGroupId', 'Required parameter userGroupId was null or undefined when calling RemoveUserGroupFromServerDataConnection.');
            }
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
...
exports.ServerConnectionClient = ServerConnectionClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.userDataTemplate = void 0;
var FormData = __nccwpck_require__(4300);
const userDataTemplate = (params) => {
    var form = new FormData();
    form.setBoundary("--alteryx");
    form.append('file', params.file, params.name);
    form.append('name', params.name);
...
exports.userDataTemplate = userDataTemplate;
//# sourceMappingURL=user-data-template.js.map
...
const utils_1 = __nccwpck_require__(2579);
const userV2_1 = __nccwpck_require__(8843);
/**
 * The User Management API provides a means form managing users.
 * @export
 * @extends {SdkClient}
 */
class UserManagementClient extends userV2_1.UserManagementClientV2 {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/users";
    }
    /**
     *
     ...
     * @memberOf UserManagementClient
     */
    GetUsersAssets(id, assetType) {
        return __awaiter(this, void 0, void 0, function* () {
            const qs = (0, utils_1.toQueryString)({ assetType: assetType });
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UserManagementClientV2 = void 0;
const sdk_client_1 = __nccwpck_require__(4709);
const modelsV2_1 = __nccwpck_require__(8052);
const user_data_template_1 = __nccwpck_require__(110);
/**
 * The User Management API provides a means form managing users.
 * @export
 * @extends {SdkClient}
 */
class UserManagementClientV2 extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrlV2 = "/user/v2";
    }
    /**
     *
     ...
     * @memberOf UserManagementClientV2
     */
    PostNewJobV2(appId, values) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('appId', 'Required parameter appId was null or undefined when calling PostNewJobV2.');
            }
            // verify required parameter 'values' is not null or undefined
            if (values === null || values === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('values', 'Required parameter values was null or undefined when calling PostNewJobV2.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
     ...
     * @memberOf AdminManagementClientV1
     */
    publishTempFileV2(file, name) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'file' is not null or undefined
            if (file === null || file === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('file', 'Required parameter file was null or undefined when calling publishTempFileV2.');
            }
            if (name === null || name === undefined) {
                throw new modelsV2_1.SDKModelsV2.RequiredError('file', 'Required parameter name was null or undefined when calling publishTempFileV2.');
            }
            const params = {};
            if (file) {
                params['file'] = file;
            ...
            return (yield this.HttpAction({
                ...
                body: (0, user_data_template_1.userDataTemplate)(params),
                multiPartFormData: true,
                //additionalHeaders: { enctype: "multipart/form-data" },
            }));
        });
...
exports.UserManagementClientV2 = UserManagementClientV2;
//# sourceMappingURL=userV2.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.worflowVersionDataTemplate = exports.worflowDataTemplate = void 0;
var FormData = __nccwpck_require__(4300);
const worflowDataTemplate = (params) => {
    var form = new FormData();
    form.setBoundary("--alteryx");
    form.append('file', params.file, params.name);
...
exports.worflowDataTemplate = worflowDataTemplate;
const worflowVersionDataTemplate = (params) => {
    var form = new FormData();
    form.setBoundary("--alteryx");
    if (params.file) {
        form.append('file', params.file, params.name);
...
exports.worflowVersionDataTemplate = worflowVersionDataTemplate;
//# sourceMappingURL=worflow-data-template.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WorkflowManagementClient = void 0;
const utils_1 = __nccwpck_require__(2579);
const worflow_data_template_1 = __nccwpck_require__(1477);
const workflowV1_1 = __nccwpck_require__(5648);
/**
 * The Workflow Management API provides a means form managing workflows.
 * @export
 * @extends {WorkflowManagementClientV1}
 */
class WorkflowManagementClient extends workflowV1_1.WorkflowManagementClientV1 {
    constructor() {
        super(...arguments);
        this._baseUrl = "/v3/workflows";
    }
    /**
     *
    ...
    CreateWorkflow(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                ...
                body: (0, worflow_data_template_1.worflowDataTemplate)(params),
                multiPartFormData: true,
                //additionalHeaders: { enctype: "multipart/form-data" },
            }));
        });
    ...
    * @param {boolean} [param.hasPrivateDataExemption]
     ...
     * @memberOf WorkflowManagementClient
     */
    AddVersionToWorkflow(workflowId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
                ...
                body: (0, worflow_data_template_1.worflowVersionDataTemplate)(params),
                multiPartFormData: true,
                additionalHeaders: { enctype: "multipart/form-data" },
            }));
        });
    ...
    DeleteWorkflow(workflowId, force) {
        return __awaiter(this, void 0, void 0, function* () {
            const qs = (0, utils_1.toQueryString)({ force: force ? force : false });
            return (yield this.HttpAction({
                verb: "DELETE",
                gateway: this.GetGateway(),
                authorization: yield this.GetToken(),
     ...
     * @memberOf WorkflowManagementClient
     */
    UpdateWorkflow(workflowId, updateWorkflowContract) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.HttpAction({
                verb: "PUT",
                gateway: this.GetGateway(),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WorkflowManagementClientV1 = void 0;
const utils_1 = __nccwpck_require__(2579);
const sdk_client_1 = __nccwpck_require__(4709);
const modelsV1_1 = __nccwpck_require__(9741);
 ...
 * @extends {SdkClient}
 */
class WorkflowManagementClientV1 extends sdk_client_1.SdkClient {
    constructor() {
        super(...arguments);
        this._baseUrlV1 = "/v1/workflows";
    }
    /**
     *
    ...
    GetAppInfoV1(appId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling GetAppInfo.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf WorkflowManagementClientV1
     */
    GetAppQuestionsV1(appId) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling GetAppQuestions.');
            }
            return (yield this.HttpAction({
                verb: "GET",
                gateway: this.GetGateway(),
     ...
     * @memberOf WorkflowManagementClientV1
     */
    GetJobsForAppV1(appId, sortField, direction, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling GetAppQuestions.');
     ...
     * @memberOf WorkflowManagementClientV1
     */
    GetStudioAppsV1(sortField, direction, offset, limit, search, packageType) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {};
            if (sortField) {
                params['sortField'] = sortField;
     ...
     * @memberOf WorkflowManagementClientV1
     */
    PostNewJobV1(appId, values) {
        return __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'appId' is not null or undefined
            if (appId === null || appId === undefined) {
                throw new modelsV1_1.SDKModelsV1.RequiredError('appId', 'Required parameter appId was null or undefined when calling PostNewJobV1.');
            }
            return (yield this.HttpAction({
                verb: "POST",
                gateway: this.GetGateway(),
...
exports.WorkflowManagementClientV1 = WorkflowManagementClientV1;
//# sourceMappingURL=workflowV1.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SecretCredentialAuth = void 0;
const debug = __nccwpck_require__(7358);
const cross_fetch_1 = __nccwpck_require__(9805);
const auth_base_1 = __nccwpck_require__(2901);
const utils_1 = __nccwpck_require__(2579);
const log = debug("alteryx-credentialauth");
class SecretCredentialAuth extends auth_base_1.AuthBase {
    /**
     ...
     */
    constructor(_gateway, _clientid, _clientsecret) {
        ...
        !(0, utils_1.isUrl)(_gateway) && (0, utils_1.throwError)("the gateway must be an URL (e.g. https://localhost:8080");
    }
    AcquireToken() {
        return __awaiter(this, void 0, void 0, function* () {
            const headers = Object.assign(Object.assign({}, this._urlEncodedHeaders), { Authorization: this._basicAuth });
...
exports.SecretCredentialAuth = SecretCredentialAuth;
//# sourceMappingURL=secret-credential-auth.js.map
 ...
 * @implements {TokenRotation}
 */
class UserAuth extends alteryx_base_1.AlteryxConnectBase {
    /**
     ...
     * @memberOf UserAuth
     */
    constructor(gateway, user, password) {
        super();
        this._user = "cli";
        this._password = "1.0.0";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.truncate = exports.isGuid = exports.checkList = exports.addAndStoreConfiguration = exports.pruneCert = exports.checksumFile = exports.removeUndefined = exports.toQueryString = exports.throwError = exports.checkAssetId = exports.retry = exports.getFullConfig = exports.loadAuth = exports.storeAuth = exports.getHomeDotAyxDir = exports.decrypt = exports.encrypt = exports.isUrl = void 0;
...
const encrypt = ({ gateway, clientID, clientSecret, passkey, appName, appVersion, createdAt, comments, selected, }) => {
...
const decrypt = (encryptedAuth, passkey) => {
    const decipher = crypto.createDecipheriv("aes-256-cbc", normalizePasskey(passkey), Buffer.from(encryptedAuth.iv, "base64"));
    let dec = decipher.update(encryptedAuth.auth, "hex", "utf8");
    dec += decipher.final("utf8");
    return dec;
};
exports.decrypt = decrypt;
const getHomeDotAyxDir = () => {
    return `${os.homedir()}/.ayx/`;
};
exports.getHomeDotAyxDir = getHomeDotAyxDir;
const storeAuth = (auth) => {
    const homeDir = (0, exports.getHomeDotAyxDir)();
    if (!fs.existsSync(homeDir)) {
        fs.mkdirSync(homeDir);
    }
    const pathName = `${(0, exports.getHomeDotAyxDir)()}auth.json`;
...
const loadAuth = () => {
    ...
    !result &&
        (0, exports.throwError)("please configure the authentication properly.");
    return result;
};
...
function addAndStoreConfiguration(configuration) {
    ...
    configuration.credentials.forEach((element) => {
        element.gateway = (0, exports.isUrl)(element.gateway) ? element.gateway : `https://localhost`;
...
function truncate(_string, limit) {
...
__exportStar(__nccwpck_require__(9685), exports);
__exportStar(__nccwpck_require__(9270), exports);
__exportStar(__nccwpck_require__(3130), exports);
var utils_1 = __nccwpck_require__(2579);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AYX_NAME = exports.AYX_VERSION = void 0;
exports.AYX_VERSION = "0.0.1";
exports.AYX_NAME = "ayx-node";
...
module.exports = __nccwpck_require__(5940)(exports);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(4296);
} else {
	module.exports = __nccwpck_require__(1843);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(1028);
...
var populate = __nccwpck_require__(5162);
...
const os = __nccwpck_require__(2087);
const tty = __nccwpck_require__(3867);
const hasFlag = __nccwpck_require__(2711);
